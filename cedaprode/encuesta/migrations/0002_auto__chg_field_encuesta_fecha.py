...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('encuesta_encuesta', 'fecha', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Encuesta.fecha'
        db.alter_column('encuesta_encuesta', 'fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'encuesta.rubrosmanejados': {
            ...
            'volumen_cacao': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'volumen_global': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        },
        'lugar.departamento': {
